...
public class ArbolAVL<T extends Comparable<T>> {
    ...
    public void add(T dato) {
        //No necesito checar si tiene o no raíz porque lo inicio con raíz 
        //Creo un arbol metiendole una raíz 
        
        //1. Inserta Normal, se mueve hasta poder ponerlo en posición
        NodoAVL<T> actual = raiz; 
        NodoAVL<T> papa = raiz; //sino lo inicializo me marca error 
    ...
    //fachilito
    private NodoAVL<T> buscaP(T dato) {
    ...
    public T borra (T elem){
        //-------1. ELIMINA NORMAL --------
        NodoAVL<T> actual = buscaP(elem); //mi buscaP me regresa el nodo o null
        
        if (actual == null) //si noestaba no lo puede quitar
        ...
        //Aqui ya se revisa si es que se necesitan rotaciones o no. 
        //Basicamente es como el inserta que hace primero y luego ya checa
        boolean bandera = false;
        ...
        while (!bandera && papaTemp != null){
            ...
            if (papaTemp.getFE() == 2)
                if (actual.getFE() >= 0)
                    ...
                    papaTemp = rotacionDerIzq(papaTemp); //estuvo más limpio hacer las rotaciones por casos y solo poner el nombre
      ...
      public String imprimeNiveles(){
        ...
        while(!cola.isEmpty()){
            ...
            if(actual.getIzq()!=null)
             ...
             if(actual.getDer()!=null)
                cola.add(actual.getDer()); 
             sb.append("Elemento: "+actual.getElem()+", "); 
